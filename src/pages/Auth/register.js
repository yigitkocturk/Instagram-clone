          ...
          <Formik
            ...
            {({ isSubmitting, isValid, dirty, values }) => (
              <Form className='grid gap-y-1.5'>
                ...
                <p className='text-xs text-[#8e8e8e] py-2  justify-center '>
                  ...
                  <br/><br/>
                  By signing up, you agree to our  <a href='/#' className='font-semibold'>Terms</a> ,<a href='/#' className='font-semibold'> Data Policy </a>
                  and <a href='/#' className='font-semibold'>Cookies Policy</a> .
                </p>
